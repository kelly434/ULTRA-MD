...
const defaultOwner = '254791802396';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || 'your nnumber' 254791802396
...
global.pairingNumber = process.env.BOT_NUMBER || 'your number';  // 254791802396
